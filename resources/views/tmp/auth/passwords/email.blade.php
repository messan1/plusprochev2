...
<section class="section pricing-hero section-offers section-publish section-100 wf-section">
    ...
    <div class="container-9 w-container">
      <div class="w-form">
        <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form" method="POST" action="{{ route('password.email') }}">
            @csrf

            <div class="form-field-wrapper">
            <div id="w-node-e498b37c-6fcd-38bc-4005-9c759db9f610-dac386f8"><label for="Nom" id="contact-email">Email</label><input type="text" maxlength="256" name="email"
                value="{{ old('email') }}" required autocomplete="email" autofocus data-name="Nom" id="Nom" class="w-input"></div>
          </div>
