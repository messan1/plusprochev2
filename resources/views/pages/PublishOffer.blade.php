                            ...
                            <div id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form"
                                ...
                                <div class="form-field-wrapper">
                                    ...
                                    <div id="w-node-_24953867-44eb-de36-2808-be4c2d36ac28-aa54153f"><label for="Nom-6"
                                            id="contact-email">Quantité à vendre * (kg)</label>
                                    ...
                                    <div id="w-node-_24953867-44eb-de36-2808-be4c2d36ac30-aa54153f"><label for="Phone-3"
                                            id="contact-phone">Prix de vente du kilo</label>
                                    ...
                                    <div id="w-node-_3e87f3c4-a634-63d2-9b89-ea77ffbfaeca-aa54153f"><label for="Phone-4"
                                            ...
                                            maxlength="256" name="colis_ttc" value=0 readonly data-name="Phone 3"
                                            id="Phone-3"></div>
                                    <div id="w-node-_66909a7b-3a14-b717-1003-068fcc86f9f8-aa54153f"><label for="Phone-4"
                                            id="contact-phone">Ce que je refuse de transporter</label>
                    ...
                    <div class="w-container">
                        <div class="w-form">
                            <div id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form"
                                ...
                                <div class="form-field-wrapper">
                                    <div id="w-node-_24953867-44eb-de36-2808-be4c2d36ac28-aa54153f"><label for="Nom-6"
                                            id="contact-email">Quantité </label>
                                        <input type="text" maxlength="256" x-model="qt" x-show="has_courrier" name="courrier_quantity"
                                            data-name="Nom 6" id="Nom-6" class="w-input">
                                    ...
                                    <div id="w-node-_4e9cf4e5-d11e-0f2c-e265-8e4a060e6f5a-aa54153f"><label for="Phone-4"
                                            id="contact-phone">Prix publié TTC</label>

                                        <input x-model="price" x-show="has_courrier" type="number" class="w-input" maxlength="256"
