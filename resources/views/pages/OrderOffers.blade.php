            ...
            <div class="w-form">
              <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form">
                <div class="form-field-wrapper">
                  <div id="w-node-_7c4238ec-34a1-2227-0577-fe461f0323b8-edc993e5" class="div-block-108"><label for="Nom" id="contact-email">Départ *</label><input type="text" maxlength="256" name="Nom" data-name="Nom" id="Nom" class="w-input"></div>
      ...
      <div class="w-form">
        <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form">
          <div class="form-field-wrapper">
            ...
            <div id="w-node-_41952306-0171-42c3-b728-4c434ee8c51d-edc993e5"><label for="Nom-7" id="contact-email">Prix hors taxe</label><input type="text" maxlength="256" name="Nom-6" data-name="Nom 6" id="Nom-6" class="w-input"></div>
            <div id="w-node-_4b93cfca-c4d9-2880-73ac-031748dcb593-edc993e5"><label for="Nom-7" id="contact-email">Frais de service</label><input type="text" maxlength="256" name="Nom-6" data-name="Nom 6" id="Nom-6" class="w-input"></div><label id="w-node-_4c0ae8c9-2f35-4774-535a-6adeba3490d6-edc993e5" class="w-checkbox checkbox-field-3"><input type="checkbox" id="CheckColis-2" name="CheckColis-2" data-name="Check Colis 2" class="w-checkbox-input"><span for="CheckColis-4" class="w-form-label">Voulez vous souscrire à une police d&#x27;assurance ?</span></label>
            <div id="w-node-c5d9a765-ab64-410e-23ee-d2b712487878-edc993e5"><label for="Phone-5" id="contact-phone">Souscrire à une police d&#x27;assurance</label><input type="number" class="w-input" maxlength="256" name="Phone-3" data-name="Phone 3" id="Phone-3"></div>
            <div id="w-node-_93640ef7-7545-1dff-b2e6-d8a040308137-edc993e5"><label for="Phone-5" id="contact-phone">Prix de l&#x27;assurance</label><input type="number" class="w-input" maxlength="256" name="Phone-3" data-name="Phone 3" id="Phone-3"></div>
          ...
          </div><label class="w-checkbox"><input type="checkbox" id="CheckColis-2" name="CheckColis-2" data-name="Check Colis 2" class="w-checkbox-input"><span for="CheckColis-3" class="w-form-label">J&#x27;accepte les conditions générales et la politique de confidentialité</span></label>
          <div class="div-block-104"><input type="submit" value="Valider la réservation" data-wait="Veuillez patienter..." class="form-btn-submit w-button"></div>
        </form>
        <div class="w-form-done">
          <div>Thank you! Your submission has been received!</div>
        </div>
