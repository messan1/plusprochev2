      ...
      <div class="w-form">
        <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form">
          <div class="form-field-wrapper">
            <div id="w-node-e498b37c-6fcd-38bc-4005-9c759db9f610-0bf06067"><label for="Email-4" id="contact-email">Email *</label><input type="email" class="w-input" maxlength="256" name="Email-3" data-name="Email 3" id="Email-3" required=""></div>
            <div id="w-node-e498b37c-6fcd-38bc-4005-9c759db9f614-0bf06067"><label for="Contact-Phone-Number-3" id="contact-phone">Mot de passe *</label><input type="tel" class="w-input" maxlength="256" name="Contact-Phone-Number-2" data-name="Contact Phone Number 2" id="Contact-Phone-Number-2"></div>
          </div>
          ...
          <div class="div-block-104"><input type="submit" value="Se connecter" data-wait="Veuillez patienter..." class="form-btn-submit w-button"></div>
          ...
          <div class="social_btn_group">
            <div class="social-box">
              <a href="#" class="social-login w-inline-block"><img src="../images/G.png" alt="" class="image-96">
