      ...
      <div data-w-id="26c853c2-15e5-acc0-1098-1540cad6d830" style="opacity:0" class="faq-wrapper">
        ...
        <div class="columns-16 w-row">
          <div class="w-col w-col-4">
            <div class="div-block-69"><img src="../images/Group-12882x_1Group-12882x.png" width="41" height="51" alt="" class="image-7">
        ...
        <div class="w-row">
          <div class="w-col w-col-4">
            <div class="div-block-69"><img src="../images/Headshot2x.jpg" width="41" height="51" alt="" class="image-7">
        ...
        <div class="w-row">
          <div class="w-col w-col-4">
            <div class="div-block-69"><img src="../images/Wow-moment-A2x.jpg" width="41" height="51" sizes="41px" srcset="../images/Wow-moment-A2x-p-500.jpeg 500w, ../images/Wow-moment-A2x-p-800.jpeg 800w, ../images/Wow-moment-A2x.jpg 960w" alt="" class="image-7">
