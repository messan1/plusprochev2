    ...
    <div class="wrapper horizontal-flex top-align vertical-flex-mobile">
      <div data-w-id="26c853c2-15e5-acc0-1098-1540cad6d830" style="opacity:0" class="faq-wrapper">
        ...
        <div class="columns-16 w-row">
          <div class="w-col w-col-4">
            <div class="div-block-69"><img src="../images/Group-12882x_1Group-12882x.png" width="41" height="51" alt="" class="image-7">
              <p class="testimonial-name"><strong>Franck Brou</strong><br>Directeur, Jumia</p>
            </div>
          </div>
        ...
        <div class="div-block-86">
          <a href="../old/listing.html" target="_blank" class="button no-max-width w-button">Comment ça marche</a>
          <a href="../old/listing.html" target="_blank" class="button no-max-width w-button">Nous contacter</a>
        </div>
      </div>
    </div>
  </div>
